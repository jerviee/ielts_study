...
const targetWords = ['capable', 'capacity', 'cape', 'capital', 'captain', 'capture', 'car', 'carbon', 'card', 'cardboard', 'care', 'career', 'careful', 'carefully', 'careless', 'cargo', 'carpenter', 'carpet', 'carriage', 'carrier'];
