...
const targetWords = ['brace','bracelet','brachiopod','bracket','brackish','bract','brad','brae','braft','braid','braille','brain','brainchild','brainsick','brainstorm','brainwash','braise','brake','bramble','bran'];
let allPassed = true;
