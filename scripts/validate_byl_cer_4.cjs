...
const targetWords = ['carrot','carry','cart','carve','case','cash','cast','castle','casual','casualty','cat','catalog','catch','category','cater','cathedral','catholic','cattle','cause','caution'];
let allPassed = true;
