...
words.forEach(w => {
    switch(w.word.toLowerCase()) {
        case 'capacity':
            w.example = 'The large stadium has a seating capacity of over 50,000 spectators for major sporting events.\n大型体育场的座位容量超过50,000名观众，可举办大型体育赛事。\nWe need to significantly expand our storage capacity to accommodate the rapidly growing inventory in our warehouse.\n我们需要大幅扩大存储容量以容纳仓库中快速增长的库存。';
            break;
        case 'cape':
            w.example = 'The ship sailed carefully around the dangerous cape during the stormy weather conditions.\n这艘船在暴风雨天气条件下小心地绕过了危险的海角。\nShe wore a stylish black cape over her elegant evening dress for the important gala event.\n她在优雅的晚礼服外面穿了一件时尚的黑色披风参加重要的晚宴。';
            break;
        case 'capital':
            w.example = 'The capital city is home to government buildings, museums, and important cultural institutions.\n首都拥有政府大楼、博物馆和重要的文化机构。\nInvestors are actively looking for opportunities to invest their capital in promising tech startups this year.\n投资者今年正在积极寻找机会将资本投资于有前途的科技初创企业。';
            break;
        case 'captain':
            ...
            break;
        case 'carbon':
            w.example = 'Scientists are studying various innovative ways to reduce carbon emissions to combat climate change.\n科学家正在研究各种创新方法来减少碳排放以应对气候变化。\nCarbon dating is commonly used to determine the age of ancient artifacts and fossils found at archaeological sites.\n碳测年法通常用于确定考古遗址发现的古代文物和化石的年代。';
            break;
        case 'card':
        ...
        case 'cardboard':
            ...
            break;
        case 'care':
            w.example = 'Parents should provide proper care and attention to their children\'s emotional needs.\n父母应该适当关心和关注孩子的情感需求。\nThe dedicated healthcare workers showed great care and compassion towards their patients during the pandemic.\n疫情期间，敬业的医护人员对病人表现出极大的关心和同情。';
            break;
        case 'career':
        ...
        case 'carefully':
            ...
            break;
        case 'careless':
            w.example = 'A careless mistake led to the loss of important data from the company computer.\n一个粗心的错误导致公司计算机中的重要数据丢失。\nDrivers should never be careless when operating a vehicle on the busy city road during rush hour.\n司机在高峰时段繁忙的城市道路上驾驶车辆时绝不能粗心大意。';
            break;
        case 'carpenter':
