...
const targetWords = ['bylaw', 'byline', 'bypass', 'byproduct', 'byre', 'byroad', 'byssinosis', 'byway', 'byword', 'cab', 'cabbage', 'cabin', 'cabinet', 'cable', 'cactus', 'cake', 'calcium', 'calculate', 'calendar', 'calf'];
