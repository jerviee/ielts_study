...
words.forEach(w => {
    switch(w.word.toLowerCase()) {
        case 'careful':
            w.example = 'Be very careful when handling fragile glass items to avoid breaking them accidentally.\n处理易碎玻璃物品时要非常小心，以免意外打破它们。\nThe meticulous scientist was careful to document every single step of the complex scientific experiment in the laboratory.\n一丝不苟的科学家小心地记录实验室里复杂科学实验的每一个步骤。';
            break;
        case 'carefully':
            ...
            break;
        case 'carpenter':
            w.example = 'The skilled carpenter built a beautiful wooden dining table for the large family.\n熟练的木匠为这个大家庭制作了一张漂亮的木制餐桌。\nMy grandfather was a talented carpenter who could fix almost anything made of wood in his workshop.\n我的祖父是一名有才华的木匠，在他的车间里几乎可以修理任何木制品。';
            break;
        case 'carriage':
